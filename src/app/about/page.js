...
export default function About() {
    return (
        <div className="about-page">
            ...
            <div><h2 className="MissionStatement">Mission Statement</h2></div>
