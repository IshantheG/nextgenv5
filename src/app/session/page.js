    ...
    return (
        ...
        <div className="Session-page">
            ...
            <div className="Week4-Container">
                ...
                <p>
                The fourth week marked the final stretch before the grand finale of the program, and there was still plenty for participants to learn. This week’s sessions were led by Allen Jain, an Advanced Entry Opportunity student at the Ivey Business School at Western University.  Allen began the week with a lesson on market analysis (Figure 13). This is a crucial part of starting any venture, and would be an important component of the design challenge. He introduced participants to SWOT (Strengths, Weaknesses, Opportunities and Threats) analysis, which is fundamental to assessing a project’s viability. The second session of the week focused on what was arguably the most important topic in the entire program, creating an effective business pitch (Figure 14). Allen shared tips on how to deliver a compelling pitch, and concluded with a mock business pitch of his own. Afterwards, the participants were given 30 minutes to prepare a pitch to sell the products they had ideated the week prior, and to present it to their peers. Through this exercise, participants were able to test their creativity and enhance their public speaking skills. The last session of the week focused on professional development. Crafting a well-developed resume, building a network and executing interviews well provides high-schoolers the ability to excel when applying for jobs. Each of the executives worked with a group of students to go over networking skills, building resumes, and mock-interviewing, so that the participants can feel more confident when entering professional or even post-secondary landscapes.
                </p>
                </div>
            </div>
            ...
            <div className="Week5-Container">
                ...
                <p>
                The final week was full of excitement, as 4 intensive weeks of learning all culminated in the grand finale. Firstly, the team split up the participants into their groups, and performed some final team-building activities. The executives encouraged participants to talk about their 3 biggest achievements to their groups, and their strengths and weaknesses. This activity was an efficient way to put into perspective each individual’s inner workings. Finally, the participants regrouped and were given the theme for their Moonshot Challenge:     
                </p>
                </div>
            </div>
